	...
	<div class="login-page">
		...
		<div class="account_grid">
			<div class="col-md-6 login-left wow fadeInLeft" data-wow-delay="0.4s">
				...
				<a class="acount-btn"	href="<c:url value="/registrationform" />" >Create an Account</a>
			</div>
					...
					<div>
						<section>
							...
							<ul class="form-header">
								<li><label for="login"><i class="fa fa-lock"></i>
										LOGIN<label for="login"></li>
							...
							<div class="login">
								<form name="login"
									...
									<ul class="ul-list">
										...
										<li><input type="text" name="j_username" required
											class="input" placeholder="Your username" /><span
											class="icon"><i class="fa fa-user"></i></span></li>
										<form:errors path="username" cssClass="error" />
										
										<li><input type="password" name="j_password" required
											class="input" placeholder="Password" /><span class="icon"><i
												class="fa fa-lock"></i></span></li>
										
										<li><input type="submit" value="Login" class="btn"></li>
										
										<li>New User ?<a href="<c:url value="/registrationform" />">Sign Up Here</a></li>
